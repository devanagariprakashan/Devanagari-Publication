...
export type Database = {
  public: {
    Tables: {
      ...
      categories: {
        Row: { id: string; name: string; slug: string; description: string | null; image_url: string | null; is_active: boolean; hindi_name: string | null; nav_group: string | null; nav_icon: string | null; nav_badge: string | null; nav_color: string | null; sort_order: number; created_at: string }
        Insert: { id: string; name: string; slug: string; description?: string | null; image_url?: string | null; is_active?: boolean; hindi_name?: string | null; nav_group?: string | null; nav_icon?: string | null; nav_badge?: string | null; nav_color?: string | null; sort_order?: number; created_at?: string }
        Update: Partial<Database['public']['Tables']['categories']['Insert']>
      }
      books: {
        Row: { id: string; slug: string; title: string; hindi_title: string | null; subtitle: string | null; author: string | null; category_id: string | null; isbn: string | null; edition: string | null; language: string | null; exam: string | null; format: string | null; price: number; original_price: number | null; discount_percent: number; rating: number; reviews_count: number; badge: string | null; badge_color: string | null; image_url: string | null; images: Json | null; demo_file_url?: string | null; demo_video_url?: string | null; description: string | null; highlights: Json | null; pages: number | null; publication: string | null; binding: string | null; in_stock: boolean; is_bestseller: boolean; is_new_release: boolean; is_featured: boolean; show_in_hero: boolean; is_active: boolean; created_at: string }
      ...
      orders: {
        Row: { id: string; order_number: string; customer_name: string | null; customer_email: string | null; customer_phone: string | null; total_amount: number; order_status: string; payment_status: string; payment_gateway: string | null; payment_method: string | null; gateway_order_id: string | null; payment_id: string | null; shipping_address: string | null; landmark: string | null; city: string | null; state: string | null; pincode: string | null; shipment_status: string | null; shipment_id: string | null; awb_number: string | null; shipment_error: string | null; shipment_response: Json | null; created_at: string; confirmed_at: string | null; shipped_at: string | null; delivered_at: string | null; cancelled_at: string | null }
        Insert: { id: string; order_number: string; customer_name?: string | null; customer_email?: string | null; customer_phone?: string | null; total_amount: number; order_status?: string; payment_status?: string; payment_gateway?: string | null; payment_method?: string | null; gateway_order_id?: string | null; payment_id?: string | null; shipping_address?: string | null; landmark?: string | null; city?: string | null; state?: string | null; pincode?: string | null; shipment_status?: string | null; shipment_id?: string | null; awb_number?: string | null; shipment_error?: string | null; shipment_response?: Json | null; created_at?: string; confirmed_at?: string | null; shipped_at?: string | null; delivered_at?: string | null; cancelled_at?: string | null }
